...
define(function(require) {
    ...
    var View = BaseView.extend({
        ...
        defaults: function() {
            ...
            options.margin = {top: 30, right: 10, bottom: 30, left: 10};
            ...
            options.scaleY = d3.scale.ordinal().rangeRoundBands([0, options.height], options.step, 0);
        ...
        redraw: function() {
            ...
            bar.append('text')
                .attr('class', 'rowchart__bar__name')
                .attr('x', 5)
            ...
            bar.append('title')
                .text(function(d) { return d.name + ': ' + options.format(d.value); });
        ...
        resize: function() {
            ...
            if (options.height !== cache.height || options.width !== cache.width) {
                ...
                options.scaleY.rangeRoundBands([0, options.height], options.step, 0);
